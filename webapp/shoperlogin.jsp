...
<div id="allbox" style="background-image: url(./Front-resources/img/shoperlogin.jpg); ">
    <!--用户登录信息-->
    <form method="post" action="loginshoper.html">
        <div id="login" class="login">
            <h1>商户登录</h1>
            <div class="form-group col-sm-9">
                <label for="shopername">账号:</label>
                <input id="shopername" name="shopername" type="text" class="form-control"/>
            </div>
            <div class="form-group col-sm-9">
            ...
            <div id="bottons">
                ...
                <a href="shoperregister.jsp">注册</a>
            </div>
        </div>
    </form>
</div>
