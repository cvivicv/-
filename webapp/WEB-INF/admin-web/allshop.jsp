                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="post" action="ShopAdd.html"  enctype="multipart/form-data">
                                ...
                                <!-- 添加信息 -->
                                    ...
                                    <div class="form-group col-sm-9">
                                        ...
                                        <input type="text" class="form-control" id="shoper" name="shoper"/>
                                    </div>
                                    <div class="form-group col-sm-9">
                                    ...
                                    <div class="form-group col-sm-9">
                                        ...
                                        <input type="text" class="form-control" id="hot" name="hot"/>
                                    </div>
                                    <div class="form-group col-sm-9">
    ...
    <table class="table table-bordered table-hover">
        ...
        <c:forEach items="${pageInfo.list}" var="shop">
            <tr>
                ...
                <td>
                    <a href="MoreShopDoing.html?event=oneshop&sid=${shop.sid}&page=${requestScope.page}"><button class="btn btn-sm btn-primary">修改</button></a>
                    <a href="MoreShopDoing.html?event=deleteshop&sid=${shop.sid}&page=${requestScope.page}" onclick="return confirm('确定将此商品删除?')"><button class="btn btn-sm btn-danger">删除</button></a>
                </td>
            </tr>
        </c:forEach>
        </tbody>
