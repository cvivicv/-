...
<div id="item">
    ...
    <div id="right-item">
        <form method="post" action="UpdateShoperDoing.html?sid=${requestScope.oneshop.sid}&page=${requestScope.page}" enctype="multipart/form-data">
            <input type="text" id="hot" name="hot" value="${requestScope.oneshop.hot}" hidden readonly/>
